...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kdg4wc0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kdg4wc0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Juliasmatius/container-kdg4wc0.git
cd container-kdg4wc0
```
...
```
docker attach container-kdg4wc0
```
